 ...
 * can never diverge — see GEMINI.md's "Generative Fix Divergence" note: this
 ...
 * normalization — GEMINI.md's Generative Fix Divergence class):
 ...
 * re-derived per site (GEMINI.md's Generative Fix Divergence class).
