  ...
  "external-job": {
    ...
    "config": {
      ...
      "external_job.submit_timeout_ms": {
        "type": "number",
        "default": 30000,
        "description": "Hard timeout (ms) for the scheduler submit subprocess (e.g. sbatch). Bounded per GEMINI.md unbounded-subprocess policy. Read by the adapter (env GSD_SLURM_SUBMIT_TIMEOUT_MS overrides)."
      },
