  ...
  useEffect(() => {
    ...
    const sampleText = async () => {
      ...
      lines.forEach(line => {
        ...
        if (metrics.width > measuredWidth) measuredWidth = metrics.width;
      });
      ...
      const lineHeight = resolvedSize * 1.35;
      const metrics = offCtx.measureText(lines[0]);
      ...
      const maxParticles = Math.max(2000, Math.min(15000, Math.floor((width * height) / 30)));
