          ...
          {CATEGORIES.map((cat) => {
            ...
            return (
              <button
                ...
                className={`text-xs font-extrabold px-4 py-2 rounded-full transition-all duration-150 uppercase tracking-wider cursor-pointer ${
                  isActive
                    ? "bg-[#151515] text-[#FFFDF7] shadow-xs active:scale-95"
