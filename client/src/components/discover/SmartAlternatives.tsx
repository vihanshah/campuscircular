...
export const SmartAlternatives: React.FC<SmartAlternativesProps> = ({ onSelectResource }) => {
  return (
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-lg font-black text-[#151515] tracking-tight">
              Not available? Try these smart alternatives.
            </h3>
            <p className="text-xs font-semibold text-[#151515]/55">
              Recommended gear alternatives with high match scores nearby
            </p>
          </div>
        </div>
